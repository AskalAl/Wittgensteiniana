...
#===============================================================================
# 
# for sure I will have SENTENCES, which can have different languages, and are
# an EXPRESSION of the same logical sentence
# then I need to have CONCEPTS.. (tags? various types?)
# INTERPRETATIONS as connections between the two
# 
#===============================================================================
...
# TODO: this has to be MPTT : btw is the ORDERING also preserved? should be
class TextUnit(mymodels.EnhancedModel):
	...
	hastype = models.ForeignKey('TextUnitType', blank=True, null="True")
	hascontents = models.ManyToManyField('TextFragment', blank=True, null="True")
	...
	class Admin(AutocompleteTreeEditor):
		...
		list_display = ( 'parent', 'editedrecord', 'review',)
...
class TextExpression(mymodels.EnhancedModel):
	"""(TextExpression : 
		...
		(we simplified things quite a lot here, as a more detailed representation would be overkill for out project)
